#!/usr/bin/env node
// Test harness for test 73 (keyword_ignore)
// Hides the "if" keyword and runs the test script
...
const scriptFile = resolve(__dirname, '73_keyword_ignore.tee');
...
// Create visitor with hidden keywords
const ioStreams = {
